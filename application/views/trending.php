        ...
        <div class="row trending-container">
            <div class=" trending-container-right">
                <div class="border-top border-dark pt-2 trending-news-right">
                    ...
                    <div class="-mx-4 mx-0" >
                        <a href="">
                            <img class="height:468px;" src="<?= base_url() ?>assets/images/main-background-img.jpg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class=" border-top border-dark col-sm-4 p-0 trending-container-left">
                <h2 class="pt-2">Most rated</h2>
                <ul class="" style="padding-left: 0; width:260px;">
                    <li>
