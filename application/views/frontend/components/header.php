            ...
            <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <div class="header-right">
                    ...
                    <ul class="header_list h-100">
                        <li class="NewsLetter  d-flex justify-content-center align-items-center  py-2 px-3 h-100  cursor-pointer">
                            <a href="<?= base_url('infographicpage') ?>" class="header-link" target="_blank" rel="noopener noreferrer">Infographics</a>
                        </li>
                        <li class="subscriptions d-flex justify-content-center align-items-center py-2 px-3 h-100  cursor-pointer">
                            <a href="<?= base_url('subscribe') ?>" class="header-link" style="line-height:20px" target="_blank" rel="noopener noreferrer">Check Prices</a>
                        </li>
                        <li class="NewsLetter  d-flex justify-content-center align-items-center  py-2 px-3 h-100  cursor-pointer">
