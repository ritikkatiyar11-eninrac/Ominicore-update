                    ...
                    <tr>
                        ...
                        <td style="width: 35%; vertical-align: top">
                            <table
                                ...
                                <tbody>
                                    <tr>
                                        <td style="font-size: 18px;color: #003366;border-bottom: 2px solid #003366;font-weight: bold;padding-bottom: 5px;">
                                            Insight
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <td style="padding: 20px 20px 0px 20px">
                <table
                    ...
                    <tbody>
                        <tr>
                            <td
                                style="width: 65%; vertical-align: top; padding-right: 20px">
                                <table
                                    width="100%"
                                    cellpadding="0"
                                    cellspacing="0"
                        ...
                        ">
                            ...
                            <td style="width: 35%; vertical-align: top">
                                <table
                                    style="border-collapse: collapse;margin: 0px;font-family: Arial, Helvetica, sans-serif;">
                                    <tbody>
                                        <tr>
                                            <td
                            ...
                            ">
                                ...
                                ">
                                                    ...
                                                    <tr>
                                                        <td
                                                            style="font-size: 14px;color: #333333;padding-top: 10px;">
                                                            <div
                                                                style="margin-bottom: 20px;background-color: white;border-radius: 8px;">
                                                                <p
                                                                    style="font-size: 14px;color: #333333;text-align: left;">
                                                                    To book Open Access suite services & gain
                                                                    first mover advantage please contact BD Team
                                                                </p>
                                                                <div style="margin-top: 20px">
                                                                    <div
                                                                        style="border-radius: 50%;width: 70px;height: 70px;overflow: hidden;">
                                                                        <img
                                                                            src="https://eninrac.com/assets/upload/nitika-sharma.jpg"
                                                                            width="70"
                                                                            height="70"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div style="width: 100%; margin-top: 10px">
                                                    <img
                                                        src="https://eninrac.com/assets/upload/ev-img-omni.png"
                                                        alt=""
                                                        style="height:160px;width: 100%;border-radius: 8px;display: block;object-fit:cover; " />
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <table
                                                    ...
                                                    cellpadding="0"
                                                    cellspacing="0"
                                                    style="font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;margin-bottom: 10px;">
                                                    <tr>
                                                        <td
                                                            style="padding-top: 10px;font-size: 18px;color: #003366;border-bottom: 2px solid #003366;font-weight: bold;padding-bottom: 5px;">
                                                            Contact
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <td style="width: 35%; vertical-align: top">
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="margin-top: 10px">
                                                <div style="width: 100%">
                                                    <img
                                                        src="https://eninrac.com/assets/upload/Power-Sector_BG.jpg"
                                                        alt=""
                                                        style="width: 100%;border-radius: 8px;display: block; object-fit:cover;" />
                                                </div>
                                                <a
                                                    href="https://store.eninrac.com/reports/powering-progress-empowering-choice-a-deep-dive-into-indias-open-access-electricity-market"
                                                    target="_blank"
                                                    style="font-size: 14px;text-align: justify;text-decoration: none;color: #003366;padding: 10px 0px;display: block;">
                                                    Powering Progress, Empowering Choice: A Deep Dive
                                                    into India's Open Access Electricity Market
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="padding-top: 20px;font-size: 18px;color: #003366;border-bottom: 2px solid #003366;font-weight: bold;padding-bottom: 5px;">
                                            Contact
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <div
                                                ...
                                                <p
                                                    style="font-size: 14px;color: #333333;text-align: left;">
                                                    To book this report or use the place for your brand advertisement contact.
                                                </p>
                                                <div style="margin-top: 20px">
                                                    <div
                                                        style="border-radius: 50%;width: 70px;height: 70px;overflow: hidden;">
                                                        <img
                                                            src="https://eninrac.com/assets/upload/samirshekhar.jpg"
                                                            width="70"
                                                            height="70"
                                                            style="border-radius: 50%;object-fit: cover;" alt="" />
                                                    </div>
                                                    <p
                                                        style="font-size: 14px;margin-left: 10px;margin-top: 10px;">
                                                        Samir Shekhar<br />
                                                        <span style="font-size: 12px">Ad Sales
                                                        </span>
                                                        <br />
                                                        <span><a
                                                                href="mailto:samir.shekhar@eninrac.com"
                                                                style="color: rgb(64, 114, 210);text-decoration: none;">samir.shekhar@eninrac.com</a></span>
                                                        <br>
                                                        <a href="tel:9602338172" style="color: rgb(64, 114, 210);text-decoration: none;">+91 9602338172</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
            ...
            <td style="padding: 20px; width: 100%; vertical-align: top">
                <table
                    ...
                    <tr>
                        <td>
                            <table
                                style="margin: 20px auto 0;width: 100%;border-spacing: 0;font-family: Arial, Helvetica, sans-serif;">
                                <tr>
                                    <td>
                                        <div class="">
                                            <a
        ...
        <tr>
            <td style="margin: 0 0 0 0; padding: 0 0 0 0; width: 100%">
                <table
                    ...
                    cellspacing="0"
                    border="0"
                    style="padding: 0 0 0 0;width: 100%;background: linear-gradient(135deg,hsla(210, 100%, 20%, 1) 0%,hsla(233, 79%, 51%, 1) 100%);color: #ffffff;line-height: 1.2;">
                    <tbody>
                        <tr>
                            <td
                                style="margin: 0 0 0 0;padding: 20px 20px 0 20px;width: 100%;">
                                <a href="https://einfews.energyinfra.market/"><img
                                        src="https://eninrac.com/assets/upload/omni-white.png"
                                        alt="einfews-footer-logo"
                                        width="120px" /></a>
                                <p
                                    style="margin: 10px 0 20px 0;padding: 0 0 0 0;font-size: 11px;width: 90%;">
                                    All rights reserved. Republication or redistribution of
                                    Eninrac Consulting content, including by framing or similar
                                    means, is prohibited without the prior written consent of
                                    Eninrac Consulting. This email contains information about
                                    Eninrac&#39;s research, insights, services, or events. By
                                    opening our emails or clicking on links, you agree to our
                                    use of cookies and web tracking technology. For more
                                    information on how we use and protect your information,
                                    please review our privacy policy (use hyperlink).
                                </p>
                                <p
                                    style="margin: 10px 0 20px 0;padding: 0 0 0 0;font-size: 11px;width: 90%;">
                                    You received this email because you are a registered member
                                    of
                                    <a
                                        href="https://eninrac.com"
                                        target="_blank"
                                        style="color: #fff">eninrac.com</a>.
                                </p>
                                <p
                                    style="margin: 10px 0 20px 0;padding: 0 0 0 0;font-size: 11px;width: 90%;">
                                    Copyright © 2024 | Eninrac Consulting Private Limited, 2nd
                                ...
                                <p
                                    ...
                                    <span><a href="" style="color: #ffffff" target="_blank">
                                            Manage subscriptions</a></span>
                                    |
                                    <span><a href="" style="color: #ffffff" target="_blank">Unsubscribe</a></span>
                                </p>
                            </td>
                        </tr>
                    </tbody>
